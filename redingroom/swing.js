...
var firebaseConfig = {
    apiKey: "AIzaSyBa9bPdDLuV0DS4BZFfqug4_FxS1jrQwwY",
    authDomain: "bdbc-f3f60.firebaseapp.com",
    projectId: "bdbc-f3f60",
    storageBucket: "bdbc-f3f60.appspot.com",
    messagingSenderId: "303398281092",
    appId: "1:303398281092:web:19801e906de61a067287d1"
  };
...
let run = () => {
  if((7 < new Date().getHours()) && (new Date().getHours() < 17) && (new Date().getDay() !== 0) && (new Date().getDate() !== 6)) {
