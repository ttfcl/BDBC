...
var firebaseConfig = {
    apiKey: "AIzaSyCtmPJZu7OzylGE7bRrNh6d-fI5svKHQ4o",
    authDomain: "bdbc2-b0b43.firebaseapp.com",
    projectId: "bdbc2-b0b43",
    storageBucket: "bdbc2-b0b43.appspot.com",
    messagingSenderId: "373106069930",
    appId: "1:373106069930:web:94174ce433bf44a6155bd3"
  };
...
let run = () => {
  if((7 < new Date().getHours()) && (new Date().getHours() < 14) && (new Date().getDay() !== 0) && (new Date().getDate() !== 6)) {
    ...
    loginButton.textContent = '프로그램은 08시~13시에 작동합니다.'
  }
}
